    ...
    <v-row justify="center">
      <v-col cols="12" md="8">
        <v-card class="pa-4 elevation-4">
          <v-card-title class="text-h4 mb-4 white--text"> Character</v-card-title>
            ...
            >
              <v-card class="character-card">
                ...
                <v-card-text>
                  ...
                  <div class="text-subtitle-2 text-black">Last known location:</div>
                  <div class="white--text mb-2">{{ character.location.name }}</div>

                  <div class="text-subtitle-2 text-black">Origin:</div>
